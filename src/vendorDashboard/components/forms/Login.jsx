...
const Login = ({ showWelcomeHandler }) => {
  ...
  //       // Fetch vendor details only if vendorId is present
  //       if (vendorId) {
  //         const vendorResponse = await fetch(
  //           `${API_URL}/vendor/get-vendor/${vendorId}`
  //         );
  ...
  //           console.log("Firm ID:", vendorFirmId, "Firm Name:", vendorFirmName);
  //         } else {
  ...
  //         alert("No vendor ID received. Please try again.");
  //       }
  //     } else {
